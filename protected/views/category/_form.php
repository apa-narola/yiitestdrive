...
<div class="form">
    ...
    <div class="row">
        <div>
            ...
            if (file_exists($images_path . '/' . $model->category_image)):
                ?>
                <img height="200" width="200" src="<?php echo Yii::app()->baseUrl . '/images/category'. '/' . $model->category_image; ?>" />
                <?php
            endif;
            ?>
        </div>
    ...
    <div class="row">
        ...
        echo $form->dropDownList(
                $model, 'parent_id', CHtml::listData(Category::model()->findAll(
                                array('condition' => 'parent_id=0',
                                    'order' => 'name ASC')), 'id', 'name'), array('options' => array($model->parent_id => array('selected' => true)), 'empty' => 'Select Parent Category'));
        ?>
